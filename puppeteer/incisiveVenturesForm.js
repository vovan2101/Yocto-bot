...
const fillIncisiveVenturesForm = async (formData) => {
    ...
    const inputSelectors = [
        ...
        '.formFieldAndSubmitContainer .cell.formCell[data-columntype="multilineText"] .contentEditableTextbox',
        '.formFieldAndSubmitContainer .cell.formCell[data-columntype="multilineText"] .contentEditableTextbox',
        ...
        '.formFieldAndSubmitContainer .sharedFormField:nth-of-type(21) .contentEditableTextbox',
        '.formFieldAndSubmitContainer .sharedFormField:nth-of-type(22) .ql-editor',
        '.formFieldAndSubmitContainer .sharedFormField:nth-of-type(25) .contentEditableTextbox',
    ];
            ...
            case 2:
                ...
                case 3:
                    ...
                    const allowedValues = [
                        ...
                        'Metaverse - AR/VR/ Other', 'Mobility / Transportation', 'Personal and Professional Services', 
